...
/**
 * This class defines the mock API service that mimics CLIO's database. It exposes
...
public class MockApiService {
   ...
   *
   * <p>If the file is not found, an empty list of books is initialized. If the file is found but
   * cannot be parsed, an error message is printed and no data is loaded.</p>
   */
   ...
   *
   * @param newBook a {@code Book} containing the updated information to replace the existing entry.
   */
  public void updateBook(Book newBook) {
    ...
    // Intentionally keep the original behavior; the functional fix belongs to Step 3.
